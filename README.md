...
I’m a full-stack engineer with a strong focus on system design and agentic AI architectures. I enjoy building production-style applications where clarity, safety, and structure matter more than shortcuts.
...
### Languages & Core
- **JavaScript (ES6+)**
- **Basic Java** (logic-focused, DSA-oriented)
...
- **CSV → Database ingestion pipelines**
- **Debugging & log-driven development**

### Version Control & Collaboration
- **Git**
- **GitHub** (feature branches, PRs, open-source contributions)
